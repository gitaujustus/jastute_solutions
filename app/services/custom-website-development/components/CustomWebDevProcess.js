...
export default function CustomWebDevProcess() {
  const steps = [
    {
    ...
    },
    {
      ...
      description: "We design the site structure, user flow, and technical architecture.",
      number: "02"
    },
    {
      icon: <FaPalette className="w-8 h-8" />,
      title: "Custom Design",
      description: "We create a unique design that reflects your brand and engages users.",
      number: "03"
    },
    {
      icon: <FaCode className="w-8 h-8" />,
      title: "Development & Integration",
      description: "We build your site with clean code, CMS integration, and optimization.",
      number: "04"
    },
    {
      icon: <FaTools className="w-8 h-8" />,
      title: "Testing & Refinement",
      description: "We test thoroughly and refine based on performance and feedback.",
      number: "05"
    },
    {
      icon: <FaRocket className="w-8 h-8" />,
      title: "Launch & Support",
      description: "We launch your site and provide ongoing maintenance and support.",
      number: "06"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-[#242B29] max-w-3xl mx-auto">
            We follow a proven process to deliver custom websites that exceed expectations and drive business growth.
          </p>
        </motion.div>

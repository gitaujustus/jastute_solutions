...
export default function CustomWebDevCTA() {
  return (
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-[#E0F0DF] mb-6">
            Ready for a website built around your business, not a template?
          </h2>
          <p className="text-lg text-[#E0F0DF]/80 mb-8 max-w-2xl mx-auto">
            Let&apos;s build something intentional. Get a custom website that works as hard as you do.
          </p>

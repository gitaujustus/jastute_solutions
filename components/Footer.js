        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4 text-[16px] md:text-[18px] 2xl:text-[20px]">
              <a 
                href="https://instagram.com/jastute.solutions" 
                target="_blank" 
              ...
              >
                ...
                <span className='text-[16px] md:text-[18px] 2xl:text-[20px]'>@jastute.solutions</span>
              </a>
              
              <a 
                href="https://facebook.com/jastutesolutions" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-[#E0F0DF]/80 hover:text-[#FCB043] transition-colors duration-300"
              >
                ...
                <span>JASTUTE Solutions</span>
              </a>
              
              <a 
                href="https://wa.me/254729144533" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-[#E0F0DF]/80 hover:text-[#FCB043] transition-colors duration-300"
              >
